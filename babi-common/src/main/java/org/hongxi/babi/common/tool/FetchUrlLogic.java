...
/**
 * Shared logic for fetching web page content and converting HTML to readable text.
 *
 * <p>This class contains no framework-specific annotations — it is used by
 * both AgentScope and LangGraph4j tool wrappers.
 */
public final class FetchUrlLogic {

    private FetchUrlLogic() {}
    ...
    /**
     * Fetches a URL and returns readable text with structure preserved.
     *
     * @param client the HTTP client to use
     * @param url    the URL to fetch
     * @return readable text content, or error/redirect message
     */
    public static String fetchUrl(HttpClient client, String url) {
    ...
    /**
     * Creates a standard HTTP client configured for web fetching.
     */
     ...
     */
    public static String extractAndConvert(String html) {
        if (html == null) return "";
