...
public class WebSearchTools {
    ...
    public String webSearch(
            @ToolParam(description = "Search query. Be specific and concise. "
                    + "For time-sensitive queries, include the year (e.g. '2026年最新电影').") String query,
            @ToolParam(description = "Maximum number of results to return (1-10, default 5).", required = false) Integer maxResults,
            @ToolParam(description = "Limit results to the last N days (0 = no limit, 7 = recent news, "
